...
/***/ function(module, exports, __webpack_require__) {
	...
	var restaurantsPromise = _axios2.default.get('/api/restaurants');

	restaurantsPromise.then(function (response) {
	    console.log("The request succeeded");
	    console.log(response);
	});

	restaurantsPromise.catch(function (error) {
	    console.log("The request failed");
	    console.log(error);
	});

	var insertPromise = _axios2.default.post('/api/restaurants', { name: 'Starbucks', description: 'The best coffee in town' });

	insertPromise.then(function (addedItems) {
